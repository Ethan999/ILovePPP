...
package com.annmars.iloveppp.ui;
...
public class TouchImageView extends ImageView {
	...
	/*
	 * private void printMatrixInfo() { float[] n = new float[9];
	 * matrix.getValues(n); Log.d(DEBUG, "Scale: " + n[Matrix.MSCALE_X] +
	 * " TransX: " + n[Matrix.MTRANS_X] + " TransY: " + n[Matrix.MTRANS_Y]); }
	 */
}